...
import { CreateSentimentAnalysisArgs } from "./CreateSentimentAnalysisArgs";
import { UpdateSentimentAnalysisArgs } from "./UpdateSentimentAnalysisArgs";
...
export class SentimentAnalysisResolverBase {
  ...
  async createSentimentAnalysis(
    @graphql.Args() args: CreateSentimentAnalysisArgs
  ): Promise<SentimentAnalysis> {
  ...
  async updateSentimentAnalysis(
    @graphql.Args() args: UpdateSentimentAnalysisArgs
  ): Promise<SentimentAnalysis | null> {
    try {
